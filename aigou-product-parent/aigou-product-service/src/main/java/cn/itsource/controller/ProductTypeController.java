...
public class ProductTypeController {
    ...
    */
    ...
    public AjaxResult save(@RequestBody ProductType productType){
        try {
            ...
            return AjaxResult.add();
        } catch (Exception e) {
            e.printStackTrace();
            return AjaxResult.add().setMessage("保存对象失败！"+e.getMessage());
        }
    }
    ...
    */
    ...
    public AjaxResult delete(@PathVariable("id") Integer id){
        ...
        e.printStackTrace();
            return AjaxResult.add().setMessage("删除对象失败！"+e.getMessage());
        }
    }
    ...
    */
    ...
    public List<ProductType> list(){
        ...
        return productTypeService.addType();
    }
